...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, back = false, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        onClick={(e: React.MouseEvent<HTMLButtonElement>) => {if(back){e.preventDefault();router.back();if(props.onClick) {props.onClick(e);}}}}
        {...props}
      />
    )
  }
